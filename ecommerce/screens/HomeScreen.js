        ...
        <ScrollView>
          ...
          >
            ...
            <Pressable onPress={() => setModalVisible(!modalVisible)}>
              <Text style={{ fontSize: 15, fontWeight: "500" }}>Deliver to Kelven -Kumasi-705636</Text>
            </Pressable>
      ...
      >
        <ModalContent style={{ width: "100", height: 400 }}>
          <View>
            <Text>
              {" "}
              style={{ fontSize: 16, fontWeight: "500" }}Choose your Location
            </Text>
          ...
          <View style={{ flexDirection: "column", gap: 7, marginBottom: 30 }}>
            ...
            >
              ...
              <Text style={{ cololr: "#0066B2", fontWeight: "400" }}>
                {" "}
                Enter your Address{" "}
              </Text>
            </View>
